...
- [ ] **Step 1: Write `examples/deps_manager.lg`**
...
- [ ] **Step 2: Fix `examples/filter_select.lg`**
...
- [ ] **Step 1: Delete updates the list in place + status**
...
- [ ] **Step 2: Loop continues (does not exit on the action)**
...
- [ ] **Step 3: Status clears on the next key**
...
- [ ] **Step 4: filter_select delete-in-place works (no throw)**
